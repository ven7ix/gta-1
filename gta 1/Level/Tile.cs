...
namespace gta_1
{
    public class Tile
    {
        ...
        public static Tile SetPavementTile(Tile tile)
        {
            ...
            if (WorldMap[tile.MapIndex.X, tile.MapIndex.Y - 1].SptireType == "roof" && WorldMap[tile.MapIndex.X + 1, tile.MapIndex.Y - 1].SptireType != "roof")
            {
                tile.Sprite = Properties.Resources.pavement_edge_end;
                return tile;
            }

            if (WorldMap[tile.MapIndex.X, tile.MapIndex.Y - 1].SptireType == "roof")
            {
        ...
        public static Tile SetWaterTile(Tile tile)
        {
            tile.SptireType = "water";

            switch (RandomTileRotation.Next(0, 3))
            {
                case 0:
                    tile.Sprite = Properties.Resources.water_1;
                    break;
                case 1:
                    tile.Sprite = Properties.Resources.water_2;
                    break;
                case 2:
                    tile.Sprite = Properties.Resources.water_3;
                    break;
            }
