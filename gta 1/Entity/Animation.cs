    ...
    internal class Animation
    {
        ...
        public static void SetAnimationSprites(IEntity entity)
        {
            if (entity is Player)
            {
                ...
                entity.AnimationSprites = new Bitmap[8, 2]; //first is frames, second is animation type
            ...
            if (entity is Weapon)
            {
                ...
                entity.AnimationSprites[0, 0] = Properties.Resources.gun_1;
                entity.AnimationSprites[0, 1] = Properties.Resources.gun_2;

                entity.Sprite = entity.AnimationSprites[0, 0];
                if ((entity as Weapon).Range > 6)
                    entity.Sprite = entity.AnimationSprites[0, 1];
